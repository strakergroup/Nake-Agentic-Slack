...
class DocComplexityErrorMessage(SlackMessage):
    ...
    def __init__(self, ext: str) -> None:
        message = _(
            ...
            "Your recently uploaded {ext} file appears to be content-heavy.\n"
            "Due to the size and complexity, there's a chance the system might not be able to process it correctly or fully support all the content.\n"
            "If the process fails, please try using a smaller version of the file.\n"
