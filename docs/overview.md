...
- [Evaluate Quote Confirmation](evaluate-quote-confirmation.md) - Admin staged AI → combined QE + Human Translation quote flow, non-admin HT parity with `master`, the cleanup path for lifting the admin-only restriction, and QE/HT resubmission prevention (RAY-79115)
