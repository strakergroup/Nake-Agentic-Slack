...
| POST   | `/mt/embed`        | Charge media subtitle embedding and write its usage row (languages Not applicable) | `app/auth/connector.py`     |
...
### 2a. `slack:job:machine:translate:quote`
